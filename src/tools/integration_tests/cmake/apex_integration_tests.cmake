...
#
# @public
function(apex_integration_tests)
  cmake_parse_arguments(ARGS "" "TESTNAME;EXPECTED_OUTPUT_DIR;COMMANDS" "LABELS"
      ${ARGN})

  if(ARG_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "apex_integration_tests() called with unused arguments: "
      "${ARG_UNPARSED_ARGUMENTS}")
  endif()

  if(NOT ARGS_EXPECTED_OUTPUT_DIR)
    message(FATAL_ERROR "You must specify EXPECTED_OUTPUT_DIR. "
      "See instructions in apex_integration_tests/cmake/apex_integration_tests.cmake")
  endif()
  ...
  configure_file(
    "${apex_integration_tests_DIR}/test_executables.py.in"
