...
public:
  ...
  std::shared_ptr<rclcpp::PollingSubscription<PointCloud2>> m_sub_filtered_points;
...
int32_t main(int32_t argc, char ** argv)
{
  ...
  EXPECT_EQ(apex::pre_init(argc, argv), APEX_RET_OK);
  EXPECT_EQ(apex::post_init(), APEX_RET_OK);
