...
#ifndef VELODYNE_DRIVER__VLS128_DATA_HPP_
#define VELODYNE_DRIVER__VLS128_DATA_HPP_
...
/// Class implementing vls-128 specific computation and caches.
/// The manual in the following link is used as the reference:
/// https://gpsolution.oss-cn-beijing.aliyuncs.com/manual/LiDAR/MANUAL%2CUSERS%2CVLP-128.pdf
class VELODYNE_DRIVER_PUBLIC VLS128Data
{
public:
...
//  static constexpr float32_t MAINTENANCE_DURATION2_US = 7.995F;
  ...
  explicit VLS128Data(const float32_t rpm);
...
#endif  // VELODYNE_DRIVER__VLS128_DATA_HPP_
