  ...
  Diagnostic & out)
{
  ...
  out.header.name = ctrl.name();
  out.header.data_stamp = state.header.stamp;
  out.header.iterations =
    static_cast<decltype(out.header.iterations)>(ctrl.get_compute_iterations());
