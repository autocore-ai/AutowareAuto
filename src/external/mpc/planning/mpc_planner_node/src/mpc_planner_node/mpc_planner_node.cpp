...
#include "mpc_planner_node/mpc_planner_node.hpp"
...
{
MpcPlannerNode::MpcPlannerNode(const std::string & name, const std::string & ns)
: PlannerBaseNode{name, ns}
{
  ...
  set_planner(std::make_unique<mpc_planner::MpcPlanner>(
      mpc_planner::PlannerConfig{limits, vehicle_param, weights}));
}
////////////////////////////////////////////////////////////////////////////////
MpcPlannerNode::MpcPlannerNode(
...
{
  set_planner(std::make_unique<mpc_planner::MpcPlanner>(planner_cfg));
}
}  // namespace mpc_planner_node
}  // namespace planning
}  // namespace motion
