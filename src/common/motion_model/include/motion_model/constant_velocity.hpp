...
#ifndef MOTION_MODEL__CONSTANT_VELOCITY_HPP_
#define MOTION_MODEL__CONSTANT_VELOCITY_HPP_
...
{
/// \brief This is a simple constant velocity motion model
class MOTION_MODEL_PUBLIC ConstantVelocity : public MotionModel<4U>
{
public:
...
#endif  // MOTION_MODEL__CONSTANT_VELOCITY_HPP_
