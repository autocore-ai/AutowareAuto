...
#ifndef COVARIANCE_INSERTION_NODE__ADD_COVARIANCE_HPP_
#define COVARIANCE_INSERTION_NODE__ADD_COVARIANCE_HPP_
...
#endif  // COVARIANCE_INSERTION_NODE__ADD_COVARIANCE_HPP_
